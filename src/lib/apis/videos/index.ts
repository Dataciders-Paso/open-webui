...
export const verifyConfigUrl = async (token: string = '') => {
	...
	const res = await fetch(`${VIDEOS_API_BASE_URL}/config/url/verify`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getVideoGenerationConfig = async (token: string = '') => {
	let error = null;

	const res = await fetch(`${VIDEOS_API_BASE_URL}/video/config`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
